...
if($TV->ext == '.mp4' && $TV->activeStorage == '2') {
	$sources = 'sources: [{
				file: "http://'.$TV->$storageURL.':1935/ukmtv/_definst_/smil:'.str_replace('_720p.mp4','.smil', $TV->file).'/jwplayer.smil"
				},{
				file: "http://'.$TV->$storageURL.'/ukmtv/_definst_/smil:'.str_replace('_720p.mp4','.smil', $TV->file).'/playlist.m3u8"
				},{
				file: "http://'.$TV->$storageURL.'/ukmtv/_definst_/smil:'.str_replace('_720p.mp4','.smil', $TV->file).'/manifest.mpd"
				},{
